...
const estilos = {
 ...
 const iconos = {
  ...
  return (
    <div 
      className={`fixed bottom-20 right-5 z-50 flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-xl shadow-slate-900/10 border text-white text-lg font-medium transition-all duration-300 animate-fade-in-up ${estilos[tipo]}`}
    >

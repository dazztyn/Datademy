      ...
      >
        ...
        <div className="space-y-4">
          <div className="border-l-2 border-blue-500 pl-4 space-y-3">
            <h4 className="text-lg font-semibold text-blue-500 uppercase tracking-wider">Fase 1: Configuración en Google Drive</h4>
            
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 1: Plantillas</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 2: Guardado de lo nuevo</p>
          ...
          <div className="border-l-2 border-purple-500 pl-4 space-y-3">
            <h4 className="text-lg font-semibold text-purple-500 uppercase tracking-wider">Fase 2: Crear el Proceso</h4>
            
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 3: Iniciar un nuevo proceso</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 4: Vincular o Crear encuestas</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 5: Asignar y Enviar</p>
          ...
          <div className="border-l-2 border-emerald-500 pl-4 space-y-3">
            <h4 className="text-lg font-semibold text-emerald-500 uppercase tracking-wider">Fase 3: ¡Todo listo!</h4>
            
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 6: Completar el proceso</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-lg text-slate-600 dark:text-slate-300">
              <p className="font-bold text-slate-700 dark:text-slate-200 mb-1">Paso 7: Visualizar y Generar Informes</p>
        ...
        <button
          onClick={onCerrar}
          className="w-full mt-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl text-2xl font-semibold hover:opacity-95 transition-opacity shadow-md"
        >

...
export default function VisualizarProceso() {
  ...
  return (
    <View className="flex-1 bg-slate-900">
      ...
      <View className="pt-16 pb-6 px-6 bg-slate-800 rounded-b-3xl flex-row items-center shadow-lg">
        <TouchableOpacity 
          onPress={() => router.back()} 
          className="mr-4 p-3 bg-slate-700 rounded-full active:bg-slate-600"
        >
          {/* Usamos un texto simple como flecha temporalmente */}
